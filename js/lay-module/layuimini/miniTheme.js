        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<ul>\n' + bgColorHtml + '</ul>\n' +
                    '</div>\n' +
                    '<div style="color: #595959;height: 50px;line-height: 50px;font-size: 16px;padding: 0 25px;border-top: 1px solid #e8e8e8;font-style: normal;display: block;">\n' +
                    '<span> 联系我们</span>\n' +
					'<div style="color: #595959;height: 30px;line-height: 30px;font-size: 14px;padding: 0 25px;font-style: normal;display: block;">' +
					'<p>加客服QQ<p/>'+
					'</div>\n'+
                    '</div>' +
                    '</div>';
