...
function(e, t) {
    ...
    function D(e) {
        ...
        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger ? r ? t.translate: -t.translate: -a.currentTranslate, !i.cssMode) if (i.freeMode) {
            ...
            if (i.freeModeMomentum) {
                ...
                if (y < t.maxTranslate()) i.freeModeMomentumBounce ? (y + t.maxTranslate() < -S && (y = t.maxTranslate() - S), b = t.maxTranslate(), C = !0, a.allowMomentumBounce = !0) : y = t.maxTranslate(),
                i.loop && i.centeredSlides && (T = !0);
                else if (y > t.minTranslate()) i.freeModeMomentumBounce ? (y - t.minTranslate() > S && (y = t.minTranslate() + S), b = t.minTranslate(), C = !0, a.allowMomentumBounce = !0) : y = t.minTranslate(),
                i.loop && i.centeredSlides && (T = !0);
    ...
    R = {
        ...
        update: {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== n) {
                    ...
                    v.length !== y && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")),
            ...
            updateClickedSlide: function(e) {
				console.log('updateClickedSlide点击事件');
                var t = this,
                a = t.params,
        ...
        slide: {
            slideTo: function(e, t, a, i) {
                ...
                if (m = n > u ? "next": n < u ? "prev": "reset", c && -g === r.translate || !c && g === r.translate) return r.updateActiveIndex(n),
    ...
    var F = {
        update: function(e) {
            ...
            r ? (g = Math.floor(i / 2) + s + o, w = Math.floor(i / 2) + s + l) : (g = i + (s - 1) + o, w = s + l);
            ...
            }), p === b && u === E && !e) return t.slidesGrid !== h && x !== f && t.slides.css(m, x + "px"),
    ...
    ee = {
        ...
        in:function(e) {
            ...
            E = w.params.zoom,
            x = b.gesture,
            T = b.image; (x.$slideEl || (w.params.virtual && w.params.virtual.enabled && w.virtual ? x.$slideEl = w.$wrapperEl.children("." + w.params.slideActiveClass) : x.$slideEl = w.slides.eq(w.activeIndex), x.$imageEl = x.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"), x.$imageWrapEl = x.$imageEl.parent("." + E.containerClass)), x.$imageEl && 0 !== x.$imageEl.length) && (x.$slideEl.addClass("" + E.zoomedSlideClass), void 0 === T.touchesStart.x && e ? (t = "touchend" === e.type ? e.changedTouches[0].pageX: e.pageX, a = "touchend" === e.type ? e.changedTouches[0].pageY: e.pageY) : (t = T.touchesStart.x, a = T.touchesStart.y), b.scale = x.$imageWrapEl.attr("data-swiper-zoom") || E.maxRatio, b.currentScale = x.$imageWrapEl.attr("data-swiper-zoom") || E.maxRatio, e ? (m = x.$slideEl[0].offsetWidth, g = x.$slideEl[0].offsetHeight, i = x.$slideEl.offset().left + y.scrollX + m / 2 - t, s = x.$slideEl.offset().top + y.scrollY + g / 2 - a, o = x.$imageEl[0].offsetWidth, d = x.$imageEl[0].offsetHeight, p = o * b.scale, u = d * b.scale, v = -(c = Math.min(m / 2 - p / 2, 0)), f = -(h = Math.min(g / 2 - u / 2, 0)), (r = i * b.scale) < c && (r = c), r > v && (r = v), (n = s * b.scale) < h && (n = h), n > f && (n = f)) : (r = 0, n = 0), x.$imageWrapEl.transition(300).transform("translate3d(" + r + "px, " + n + "px,0)"), x.$imageEl.transition(300).transform("translate3d(0,0,0) scale(" + b.scale + ")"))
        },
        out: function() {
            var e = this,
            t = e.zoom,
    ...
    te = {
        ...
        load: function() {
            ...
            function d(e) {
				if(r){
					return m(e).attr("data-swiper-slide-index");
				}else{
					return m(e).index();
				}
            ...
            if (n.loadPrevNext) if (l > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
				...
				if(w.length > 0){
					e.lazy.loadInSlide(d(w));//下
				}
                var y = t.children("." + a.slidePrevClass);
				if(y.length > 0){
					 e.lazy.loadInSlide(d(y))//上
				}
				huadong(w,y);
            }
        },
    ...
    ie = {
        ...
        init: function() {
            ...
            s && s.length && (e.a11y.makeElFocusable(s), "BUTTON" !== s[0].tagName && (e.a11y.addElRole(s, "button"), s.on("keydown", e.a11y.onEnterKey)), e.a11y.addElLabel(s, t.nextSlideMessage), e.a11y.addElControls(s, l)),
...
var Swiper = new Swiper('.swiper-container', { 
    ...
    on: { 
        slideChangeTransitionStart: function(e){ 
            if ( $('.swiper-slide-active').hasClass('is_blank')) { 
                $('footer,.sidebar,.swiper-pagination').hide(300); //隐藏侧边栏
				$('.sidebar1').hide(300); //隐藏侧边栏
            }else{
				...
				if(tempData!='{}' && tempData!='' && tempData!=null && tempData!=undefined && tempData!='undefined'){
					...
					$('.sidebar .sidebar-content .logo img').attr('src',AnchorData.head);
					$('.sidebar .sidebar-content .kwai a').attr('href','kwai://profile/'+AnchorData.user_id);
					...
					if(AnchorData.state==0){//判断是否点赞
						$('.sidebar .sidebar-content .likes').removeClass('done')
					}else{
						$('.sidebar .sidebar-content .likes').addClass('done')
					}
					
					$('.sidebar1 .anchor-name').html(AnchorData.name+" "+AnchorData.user_id);
					$('.sidebar1 .anchor-autograph').html(AnchorData.autograph);
				}

				
				
                $('footer,.sidebar,.swiper-pagination').show(); //显示侧边栏
				$('.sidebar1').show();//侧边栏
            } 
        },
...
var LastI=-1;
function huadong(w,y){
	var imgy=$(y).children('img');//上
	var imgw=$(w).children('img');//下
	var Now=imgy.attr('i');
	var userid=imgy.attr('userid');
	if(Now!=undefined && Now!='undefined' && Now!='' && Now!=null){
		NowI=parseInt(Now);
		if(LastI>NowI){
			cha=LastI-NowI;
		}else{
		...
		//console.log(LastI,NowI);
		if(cha<=1){
			if(LastI<=NowI){
				console.log(LastI,NowI,'下滑动已经审核',userid);
				UpShAnchor(imgy);
			}else{
				console.log(LastI,NowI,'上滑动');
			}
		}
		LastI=NowI;
	}else{
